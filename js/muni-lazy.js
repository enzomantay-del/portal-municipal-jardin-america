 ...
 * Mejora Time to Interactive sin cambiar el comportamiento visible.
 */
(function () {
  "use strict";
  ...
  var SECONDARY = [
    ...
    "js/muni-consultas-conocimiento.js?v=20260713perf",
    "js/muni-consultas.js?v=20260713perf",
  ...
  function boot() {
    ...
    // Cargar AmiBot al primer click en triggers, o en idle
    var early = false;
    document.addEventListener(
      "click",
      function (e) {
        if (early) return;
        if (!e.target.closest("[data-open-consultas], #muni-consultas-float, .muni-acceso-card")) return;
        early = true;
        loadMany(list.slice(0, 3)).catch(function () {});
      },
      true
    );
